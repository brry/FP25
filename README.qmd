...
See [here](https://github.githistory.xyz/brry/FP25/blob/main/README.qmd) for a nicely animated version history (works for any file on github). Sorry if your edits got lost in my clean-up - feel free to add them again.
...
print('goodbye')
```
```{r, Pauline, echo=FALSE}
message("Hi everyone, Happy December")
message("Seasons Greetings to everyone")
```
